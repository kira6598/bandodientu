...
import { CART_URL } from "../config/globalVariable";  
 ...
 // eslint-disable-next-line react-hooks/exhaustive-deps
        ...
        function removeItem(e){
           ...
           .then(()=>setData(data.filter(e=>!Object.values(e).includes(key)))).catch(er=>console.log(er)).finally(() =>{
        ...
        function handleInc(e){
            ...
            const priceVal=e.target.parentNode.parentNode.parentNode.childNodes[3].childNodes[0].textContent;
            const priceNumb= Number(priceVal.substring(0,priceVal.length-2).split(",").join(""))
            ...
            return (
                <tr>       
                            ...
                            <td className="cart-ttl">
                                <a href="/product">{props.productName}</a>
                            </td>
                            <td className="cart-price">
                                <b>{convertToString(props.price)  }</b>
                            </td>
                            ...
                            <td className="cart-del">
                                <a href="/#" className="cart-remove" id={`${props.id}`}onClick={removeItem}> </a>
                            </td>
                </tr>
            )
        }         
    ...
    <section className="container stylization maincont">
        ...
        <form >
            ...
            <div className="cart-submit">
                ...
                <a href="/#" className="cart-clear" onClick={handleClear}>Clear cart</a>
            </div>
        </form>
